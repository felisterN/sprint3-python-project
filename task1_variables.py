...
for game in video_game_sales:
    sum_global_sales = sum_global_sales + game[GLOBAL_SALES]
print(sum_global_sales)

avg_global_sales= sum_global_sales/total_games
print(avg_global_sales)
#c)
highest_global_sales=video_game_sales[0][GLOBAL_SALES]
top_game_share=highest_global_sales/sum_global_sales*100
